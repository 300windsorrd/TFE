...
const DARK_MODE_COLORS = ['#f50000', '#f4ab2d', '#ffffff'] as const;
const LIGHT_MODE_COLORS = ['#f50000', '#f4ab2d', '#303030'] as const;
...
export default function LiquidEther({
  ...
  const paletteStops = useMemo(() => {
    ...
    return theme === 'light' ? Array.from(LIGHT_MODE_COLORS) : Array.from(DARK_MODE_COLORS);
  }, [colors, theme]);
  ...
  useEffect(() => {
    ...
    const root = document.documentElement;
    const updateTheme = () => setTheme(getPreferredTheme());
    updateTheme();
